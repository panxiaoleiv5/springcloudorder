package com.pxl.order.service.feign;


import com.pxl.common.dto.ResultData;
import com.pxl.order.service.hystrix.CommodityFeignServiceError;
 ...
 */
@FeignClient(name = "${feign.remote.commodity-service}", path = "/commodity", fallback = CommodityFeignServiceError.class)
